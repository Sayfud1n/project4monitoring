                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-text">
                                <img src="{{ asset('backend/assets/images/logo-light-text.png') }}" alt="homepage"
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href=""
                                ...
                                <span class="m-l-5 font-medium d-none d-sm-inline-block">sayfudin hamdan<i
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    ...
                                    <div class="m-l-10">
                                        <h4 class="m-b-0">sayfudin hamdan</h4>
                                        <p class=" m-b-0">sayfudin@gmail.com</p>
                                    </div>
                                </div>
